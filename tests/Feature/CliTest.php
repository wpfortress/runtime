...
final class CliTest extends TestCase
{
    ...
    /** @test */
    public function it_processes_successful_cli_invocation(): void
    {
        $response = new Response(
            body: json_encode(['cli' => 'ls -la']),
            headers: [
        ...
        self::assertStringContainsString(
            needle: '"exitCode":0',
            haystack: $lastRequest->getInput(),
        );
    }

    /** @test */
    public function it_processes_unsuccessful_cli_invocation(): void
    {
        $response = new Response(
            body: json_encode(['cli' => 'foo']),
            headers: [
                'Lambda-Runtime-Aws-Request-Id' => '8476a536-e9f4-11e8-9739-2dfe598c3fcd',
                'Lambda-Runtime-Deadline-Ms' => 1542409706888,
                'Lambda-Runtime-Invoked-Function-Arn' => 'arn:aws:lambda:us-east-2:1234567890:function:custom-runtime',
